    ...
    <div class="content_botbg">
      ...
      <div class="content_res">
		...
		<div class="shadowblock_out">
            ...
            <div class="shadowblockdir" style="border-radius: 6px; height: 128px; padding: 8px 28px 5px; border: 3px solid rgb(218, 218, 218);">

                <div class="sliderblockdir" >
                     <div class="banner_two" style="width: 383px; float: left; margin-right: 5px;">
						<?php cp_banner_three_abia(); ?>
					 </div>
                     <div class="banner_three" style="width: 380px; float: left;">
						<?php cp_banner_two_abia(); ?>
					 </div>
