	...
	<li>
		<div id="app-attachment-upload-container">
			...
			<div class="app-attachment-info">
				...
				<p class="small"><?php printf( __('You are allowed to upload %s file(s).', APP_TD), $options['allowed_files'] ); ?> <?php printf( __('Total file size: %s.', APP_TD), strtoupper($options['max_file_size']) ); ?></p>
...
function appthemes_plupload_enqueue_scripts() {
	...
	$app_plupload_config = array(
		...
		'plupload' => array(
			...
			'filters' => array( array( 'title' => __('Allowed Files', APP_TD), 'extensions' => 'jpg,gif,png,jpeg' ) ),
			'multipart' => true,
