...
/**
 *
 * Emails that get called and sent out for Greenaira
 * @package Greenaira
 * @author Madhur
...
function cp_new_ad_email($post_id) {
    ...
    $headers = 'From: '. __( 'Greenaira Admin', APP_TD ) .' <'. get_option('admin_email') .'>' . "\r\n";
...
function cp_owner_new_ad_email($post_id) {
    ...
    $message .= sprintf( __( 'Thank you for your recent submission! Your ad listing has been submitted for review and will not appear live on our site until it has been approved. Below you will find a summary of your ad listing on %s website.', APP_TD ), $blogname ) . "\r\n\r\n";
    $message .= __( 'Ad Details', APP_TD ) . "\r\n";
    $message .= __( '-----------------', APP_TD ) . "\r\n";
    $message .= __( 'Title: ', APP_TD ) . $ad_title . "\r\n";
    $message .= __( 'Category: ', APP_TD ) . $ad_cat . "\r\n";
