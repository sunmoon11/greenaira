...
// include all the core admin Ads files
...
?>
        ...
        <h2><?php _e( 'Ads Dashboard', APP_TD ); ?></h2>
        ...
        <div class="dash-wrap">
			...
			<div class="postbox">
				...
				<h3 class="hndle"><span><?php _e( 'Ads Info', APP_TD ); ?></span></h3>
...
function cp_delete_all_options() {
    ...
    echo '<p class="info">' . __( 'All Ads options have been deleted from the WordPress options table.', APP_TD ) . '</p>';
}
...
function cp_flush_all_cache() {
	...
	foreach ( $app_transients as $key => $value ) {
		...
		$output .= sprintf( '<br />' . __( "Ads '%s' cache has been flushed.", APP_TD ) . '<br />', $value );
	}
...
?>
        ...
        <div class="wrap">
            <div class="icon32" id="icon-options-general"><br /></div>
            <h2><?php _e( 'Ads System Info', APP_TD ); ?></h2>
			...
			if ( isset($_GET['reinstall']) )
			    echo '<p class="info">' . __( 'Ads was successfully reinstalled.', APP_TD ) . '</p>';
            ?>
		...
		<div id="tabs-wrap">
			...
			<div id="tab0">
                ...
                <table class="widefat fixed" style="width:850px;">
                    ...
                    <tbody>
                        <tr>
                            <td class="titledesc"><?php _e( 'Ads Version', APP_TD ); ?></td>
                            <td class="forminp"><?php echo $app_version; ?></td>
                        </tr>

                        <tr>
                            <td class="titledesc"><?php _e( 'Ads DB Version', APP_TD ); ?></td>
				...
				<form method="post" id="mainform" action="">
                    <tr>
                        ...
                        <td class="forminp">
                            <p class="submit"><input class="button-secondary" name="save" type="submit" value="<?php _e( 'Flush Entire Ads Cache', APP_TD ); ?>" /><br />
                        <?php _e( "Sometimes you may have changed something and it hasn't been updated on your site. Flushing the cache will empty anything that Ads has stored in the cache (i.e. category drop-down menu, home page directory structure, etc).", APP_TD ); ?>
                            </p>
					...
					<form method="post" id="mainform" action="">
						<tr>
							...
							<td class="forminp">
								<p class="submit"><input class="button-secondary" onclick="return confirmBeforeDeleteTbls();" name="save" type="submit" value="<?php _e( 'Delete Ads Database Tables', APP_TD ); ?>" /><br />
							<?php _e( 'Do you wish to completely delete all Ads database tables? Once you do this you will lose any custom fields, forms, ad packs, etc that you have created.', APP_TD ); ?>
								</p>
					...
					<form method="post" id="mainform" action="">
						<tr>
							...
							<td class="forminp">
								<p class="submit"><input class="button-secondary" onclick="return confirmBeforeDeleteOptions();" name="save" type="submit" value="<?php _e( 'Delete Ads Config Options', APP_TD ); ?>" /><br />
							<?php _e( 'Do you wish to completely delete all Ads configuration options? This will delete all values saved on the settings, pricing, gateways, etc admin pages from the wp_options database table.', APP_TD ); ?>
								</p>
                    ...
                    <tr>
                        ...
                        <td class="forminp">
                            <form action="admin.php?page=settings" id="reinstall-form" method="post">
                                <p class="submit btop">
                                    <input class="button-secondary" type="submit" value="<?php _e( 'Rerun Ads Migration Script', APP_TD ); ?>" name="migrate" /><br />
			                        <?php _e( "If you're still using Ads or the script timed out, click this button. It will attempt to rerun the migration script again. Running this script won't do any harm if you aren't sure about it.", APP_TD ); ?> <br /><br />
                                </p>
...
function cp_csv_importer() {
	...
	$args = array(
		'taxonomies' => array( APP_TAX_CAT, APP_TAX_TAG, APP_TAX_CAT_STATE ),
		...
		'custom_fields' => array(
			...
			//'state'       => 'cp_state',
			'country'     => 'cp_country',
			'Business Name' => 'cp_business_name',
			'Business Phone' => 'cp_business_phone',
			'Business Email' => 'cp_business_email',
			'Business Address' => 'cp_business_address',
			'BB Pin' => 'cp_bb_pin',
			'Website Url' => 'cp_website_url'
		),
