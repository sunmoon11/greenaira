...
?>
    ...
    <div id="respond">
        ...
        <h2 class="dotted"><?php comment_form_title( __( 'Leave a Comment ( No Login Required)', APP_TD ), __( 'Leave a Reply to %s', APP_TD ) ); ?></h2>
        ...
        <?php else : ?>
            ...
            <form action="<?php echo site_url('/wp-comments-post.php'); ?>" method="post" id="commentform" class="commentform">
                ...
                <p class="comments">
                    ...
                    <input name="submit" type="submit" id="submit" tabindex="5" class="btn_orange" value="<?php _e( 'Leave a Comment', APP_TD ); ?>" />
